...
class StandardConvBlock(nn.Module):
    """Capacity-matched standard Conv replacement for RepNCSPELAN4 ablation.
    Conv1x1 -> Conv3x3 -> Conv3x3 -> Conv1x1 with exactly 625,408 params,
    identical to RepNCSPELAN4(512, 256, 512, 64, n=1).
    """
    def __init__(self, c1, c2, c3, c4, n=3,
                 bias=False, act="silu"):
        super().__init__()
        self.conv1 = ConvNormLayer_fuse(c1, 154, 1, 1, bias=bias, act=act)
        self.conv2 = ConvNormLayer_fuse(154, 155, 3, 1, bias=bias, act=act)
        self.conv3 = ConvNormLayer_fuse(155, 200, 3, 1, bias=bias, act=act)
        self.conv4 = ConvNormLayer_fuse(200, c2, 1, 1, bias=bias, act=act)
